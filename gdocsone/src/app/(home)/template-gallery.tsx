...
export const TempGallery = () => {
    ...
    // remember THAT error of id=1 when creating a new one? It was the toast's ID being returned because you were not using async. I hate ts
    const onTemplateClick = async (title: string, initialContent: string) => {
        ...
        try {
            ...
            toast.error("Something went wrong loading templates");
        } finally {
            setIsCreating(false);
        }
    }
